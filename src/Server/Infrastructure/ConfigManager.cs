...
public class ConfigManager : IConfigManager
{
    ...
    public void AddOrUpdateSetting<T>(string file, string key, T value, bool reload)
    {
        ...
        {
            Debug.WriteLine($"Hyke It Error: Error Updating App Setting {key} - {ex}");
        }
    }
    ...
    {
        return _config.GetSection(sectionKey);
    }
    ...
    public void RemoveSetting(string file, string key, bool reload)
    {
        ...
        {
            Debug.WriteLine($"Hyke It Error: Error Removing App Setting {key} - {ex}");
        }
    }
